    ...
    public class OperadorService
    {
        ...
        public OperadorVM consultaDatosPersonalesYLic(string tipoDocumento, string nroDocumento)
        {
            ...
            if (tipoDocumento == "2")
            {
                ...
                if (persona.ResultadoProcedimientoVM.CodResultado == 1)
                {
                ...
                {
                    operador.ResultadoProcedimientoVM.CodResultado = persona.ResultadoProcedimientoVM.CodResultado;
                    operador.ResultadoProcedimientoVM.NomResultado = persona.ResultadoProcedimientoVM.NomResultado;
        ...
        public OperadorVM ConsultaPapeleta(string tipoDocumento, string nroDocumento)
        {
            ...
            try
            {
                ...
                //var resgistro = jsonString["GetDatosPapeletasMTCResponse"]["GetDatosPapeletasMTCResult"]["diffgram"]["NewDataSet"]["Table"]["@id"];
                ...
                if (ExisteData != null)
                {
                    ...
                    {
                        string registro = x.ToString();
                        if (registro == "\"@id\": \"Table1\"")
                        {
                            if (jsonResponse["TIPOPIT"].ToString() == "G")
                            {
                                cantidadGrave++;
                                operador.GRAVE = cantidadGrave;
                            }
                            else if (jsonResponse["TIPOPIT"].ToString() == "M")
                            {
                                cantidadMuyGrave++;
                                operador.MUY_GRAVE = cantidadMuyGrave;
                            }
                            operador.PUNTOS_FIRME = jsonResponse["PUNTOS_x0020_FIRMES"].ValorEntero();
                            break;
                        }
                        else
                        {
